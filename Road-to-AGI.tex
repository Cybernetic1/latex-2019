...
\begin{itemize}
	\item BERT 的革命性意义 在於： 它利用平常的文本，induce 出知识，而这 representation 是\emp{通用的} (universal):
	\begin{equation}
	\vcenter{\hbox{\includegraphics[scale=0.6]{BERT-architecture.png}}}
	\end{equation}
	换句话说： representation 压缩了句子的意思，而它可以应用在别的场景下
	
	\item This implies that human-level AI can be \textit{induced} from existing corpora, 而\emp{不需要重复像婴儿一般的学习阶段}
