...
$\vect{F}_{\mathrm{sym}}$ means that the function is invariant under the action of the symmetric group $\mathfrak{S}_k$ over propositions.  Such symmetric NNs have been proposed in \cite{Gens2014} \cite{Bie2019} \cite{Ravanbakhsh2017} .
