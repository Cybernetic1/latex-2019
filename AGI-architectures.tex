...
\title[On AGI architecture]{\Huge《论 AGI 的架构》\\{\footnotesize \today 中期报告}} % The short title appears at the bottom of every slide, the full title is only on the title page
