...
\title[On AGI architecture]{\Huge《论 AGI 的架构》\\{\footnotesize 2019年 中期报告}} % The short title appears at the bottom of every slide, the full title is only on the title page
...
\begin{itemize}
	...
	\item 但我之前提议用 \textbf{逻辑结构} 作为 bias，是否\red{多此一举}呢？！ \includegraphics[scale=0.05]{../crying-laughing.jpg}
\end{itemize}
\end{frame}
...
\begin{itemize}
	...
	\item 暂未知这方向有没有好处 \includegraphics[scale=0.05]{../crying-laughing.jpg}
\end{itemize}
\end{frame}
