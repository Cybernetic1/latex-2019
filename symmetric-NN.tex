...
Such a requirement would impose some constraints on the weights of the neural network.  For a long time, I thought it would be impossible to realize such constraints in a neural network.  But thanks to Domingos and Gens's 2014 idea
...
, that inspired me to propose a solution.
