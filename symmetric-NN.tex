...
\boxed{\mbox{next layer}} \quad o_{\ell} &=& \sum_j \sum_i W_{ij}^{\ell} o_i o_j \quad \boxed{\mbox{current layer}}
\end{eqnarray}
...
We need to consider equations (\ref{eqn:do-k-dW}) and (\ref{eqn:dE-do-k}).
