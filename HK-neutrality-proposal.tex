...
\listofframes
\vspace*{0.5cm}
我建議 用所得的獎金，成立香港的 中立派

政綱 和 基本思想 如下，但仍會不斷 修正 和 改進
...
\begin{itemize}
	...
	\item 「中国模式」令中国近10-20年经济起飞，一定做对了某些事。 它似乎证明了民主对於经济进步是不必要的。 印度有民主，但经济一样起唔到飞
...
\begin{itemize}
	...
	\item Martin Jacques:「回归后香港沿用了殖民政府的系统，但这系统只适合执行殖民统治者的命令，而缺乏一个有效的政治机制」
...
\begin{itemize}
	...
	\item 有报道指，中央在 2017 年花在广东／香港的 维稳费 已达 1,214亿元 的惊人数字，中立派 可以为中国解决一大烦恼
