...
\frametitle{Recurrent neural networks}
	Structure of RNN can be seen as similar to (\ref{fig:Turing-machine}):
	\begin{equation}
...
\Wider[1em]{
\begin{itemize}
	\item The commutativity of $\wedge$ is perhaps the most important law of logic:
	\begin{equation}
	\mbox{hungry} \wedge \mbox{penniless} \Leftrightarrow \mbox{penniless} \wedge \mbox{hungry}
	\end{equation}
	\item Could be understood as:  When deducing a conclusion from some premises, the propositions in the premise could be presented in any {\color{red}\textbf{order}}, even containing irrelevant propositions
